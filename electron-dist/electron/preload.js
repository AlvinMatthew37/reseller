...
const resellerApi = {
    ...
    schedule: {
        ...
        upsertDayNote: (date, generalNote) => ipcRenderer.invoke('schedule:upsert-day-note', date, generalNote),
        addVendorToDay: (input) => ipcRenderer.invoke('schedule:add-vendor-to-day', input.date, input.vendorId),
        updateVendorNote: (scheduledVendorId, vendorNote) => ipcRenderer.invoke('schedule:update-vendor-note', scheduledVendorId, vendorNote),
        removeVendorFromDay: (scheduledVendorId) => ipcRenderer.invoke('schedule:remove-vendor-from-day', scheduledVendorId),
    },
    backup: {
