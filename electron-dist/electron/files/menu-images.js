...
export async function selectAndImportMenuImage(browserWindow) {
...
export function writeImportedMenuImage(fileName, base64Data) {
...
export function getMenuImagePreviewUrl(imagePath) {
